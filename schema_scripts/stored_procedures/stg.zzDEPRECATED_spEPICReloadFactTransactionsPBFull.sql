...
CREATE PROCEDURE [stg].[zzDEPRECATED_spEPICReloadFactTransactionsPBFull] as
...
-- 01/27/2025 - Chris Cross - Created deprecated version to incorporate logic for debit adjustments tied to payments
-- =============================================
