...
CREATE PROCEDURE [stg].[spAPMReloadFactTransactions2Full] as

--EXEC [stg].[spAPMReloadFactTransactions2Incremental]

BEGIN

DECLARE @StartDate date = '1/1/2020'--DATEADD(DAY,-10,GETDATE())
