CREATE PROCEDURE [rpt].[spSelectBlueBookCharges] 
...
SET NOCOUNT ON
	...
	SELECT
			...
			,t.TransactionReportingPeriodID as ReportingPeriod
	...
	WHERE 1=1
		...
		AND t.TransactionDateOfPosting between @12MonthStartDate and @EndDate --'9/1/2022' and '9/30/2023'
