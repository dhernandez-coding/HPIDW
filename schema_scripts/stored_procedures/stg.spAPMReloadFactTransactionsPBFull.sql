CREATE PROCEDURE [stg].[spAPMReloadFactTransactionsPBFull] as
...
INSERT INTO #Temp_APM_Dx
	...
	FROM OPENQUERY([TIEVMDB03], '
	  ...
	  FROM Ntier_627200.PM.Vouchers v 
		  INNER JOIN Ntier_627200.PM.vwGenSvcDiagInfo d ON v.Voucher_ID = d.Voucher_ID
	  WHERE 1=1
...
/*Load Charges into #Staging*/
    ...
    GROUP BY
		...
		/* Old Charge Query in case we need to revert back */
