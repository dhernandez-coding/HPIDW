...
-- =============================================
CREATE PROCEDURE [stg].[spMedhostCHReloadDimSpecialtiesFull]
AS
BEGIN
SET NOCOUNT ON;
...
-- HOSP: NS, SERVER: HOSPF100, SOURCEID: 2
 ...
 DELETE FROM dim.Specialties WHERE SpecialtyDataSourceID = 8

insert into dim.Specialties

SELECT 
	  CONCAT('8~',s.SPECOD) as [SpecialtyID]
      ,8 as [SpecialtyDataSourceID]
