...
-- Description:	Extracts, Transforms and Loads Procedure Code Data from Medhost Northwest Surgical Hospital Source System into a dim Table
-- Change Control
--	1. 03/15/2023 - Ryan Tisserand - Initial build of procedure
-- =============================================
CREATE PROCEDURE stg.spMedhostNSReloadDimProcedureCodesFull
AS
BEGIN
SET NOCOUNT ON;

delete from dim.ProcedureCodes where ProcedureCodeDataSourceID = 2
...
select
	'2~' + p.PRCODE_ ProcedureCodeID,
	2 ProcedureCodeDataSourceID,
