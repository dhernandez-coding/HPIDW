...
CREATE PROCEDURE [rpt].[spPG_HPI_CH_Outpatient_PTDaily_REVISED] @STARTDATE date, @ENDDATE date AS
BEGIN
SET NOCOUNT ON;
...
select
	...
	,s.code lang
	,sub.OriginPoint as OriginPoint --sub.admit_source_c OriginPoint
	,'' HospUnitLoc
