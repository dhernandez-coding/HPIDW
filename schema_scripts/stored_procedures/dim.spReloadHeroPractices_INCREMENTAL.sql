...
-- Edit date:   
-- Description:	INCREMENTAL reload for dim.Practices--_Hero from HPI App
-- ============================================= 
*/
BEGIN
...
/*-----DELETE/DEACTIVATE old records----*/
	...
	DELETE FROM dim.Practices--_Hero
...
/*-----INSERT new records-----*/
	...
	INSERT INTO dim.Practices--_Hero
	(PracticeID
	,PracticeDataSourceID
	,PracticeSourceID
	,PracticeName
