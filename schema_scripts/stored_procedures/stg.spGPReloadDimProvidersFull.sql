...
/*07.31.2026 Create record for Christopher S. Hume*/
INSERT INTO dim.Providers (ProviderID,ProviderDataSourceID,ProviderSourceID,ProviderAbbreviation, ProviderLastName,ProviderIsActive,ProviderUpdatedDatetime,ProviderNPI) SELECT '10~CSH',10,'CSH','CSH','CHRISTOPHER S. HUME',1,getdate(),'1578665063'

/*07.31.2026 Create record for Erin L. Balzer*/
INSERT INTO dim.Providers (ProviderID,ProviderDataSourceID,ProviderSourceID,ProviderAbbreviation, ProviderLastName,ProviderIsActive,ProviderUpdatedDatetime,ProviderNPI) SELECT '10~ELB',10,'ELB','ELB','ERIN L. BALZER',1,getdate(),'1881955508'
