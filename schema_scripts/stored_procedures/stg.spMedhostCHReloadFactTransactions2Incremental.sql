CREATE PROCEDURE [stg].[spMedhostCHReloadFactTransactions2Incremental]
as

BEGIN
/*Deletes last 10 days of posted transactions and reloads just those days*/
DELETE FROM fact.Transactions2 WHERE TransactionDataSourceID = 8 AND TransactionDateOfPosting >= convert(date,DATEADD(DAY,-10,GETDATE()))
...
INSERT INTO fact.Transactions2
  ...
  SELECT 
	...
	,CONCAT('8~',CASE WHEN c.AINSCO = '0' THEN '999' ELSE c.AINSCO END) as TransactionPayerID 
