CREATE VIEW [fact].[vPBPaymentsandAdjustmentsCorrected] AS
SELECT 
	t.[TransactionID]
...
LEFT JOIN rpt.BCBSCorrected bc on bc.TransactionParentSourceID = CONCAT(t.[TransactionDatasourceID],'~',t.[TransactionParentSourceID])
WHERE 1=1 
