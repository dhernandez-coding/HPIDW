...
SELECT 
    ...
    CASE 
        WHEN vc.VisitCaseService IN ('Gastroenterology', 'GI', 'Endoscopy') THEN 'Endoscopy-Gi-Rn''s' 
        ELSE 'Outpatient Surg S RN' 
...
WHERE vc.VisitCaseDatesourceID = 5
  ...
  AND vc.VisitCasePatientClass IN ('Outpatient Surgery', 'Outpatient Extended Recovery')
