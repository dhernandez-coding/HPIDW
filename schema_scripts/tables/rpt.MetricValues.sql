CREATE TABLE [rpt].[MetricValues] (
    ...
    [ReportGroup1] VARCHAR(500) NULL,
    [ReportGroup2] VARCHAR(500) NULL,
    [ReportGroup3] VARCHAR(500) NULL,
    [ReportGroup4] VARCHAR(500) NULL,
    [ReportGroup5] VARCHAR(500) NULL,
    [ReportGroup6] VARCHAR(500) NULL,
    [ReportGroup7] VARCHAR(500) NULL,
